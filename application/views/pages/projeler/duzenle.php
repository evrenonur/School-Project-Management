<div class="col-md-12">
    <div class="tile">
        ...
        <div class="tile-body">
            ...
            <?= form_open(base_url('projeler/update'), 'enctype="multipart/form-data"'); ?>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="teslim_aciklama" rows="4" placeholder="Teslim edeceğiniz projeniz hakkında açıklamanız veya notunuz var ise yazabilirsiniz."><?=$proje->teslim_aciklama?></textarea>
        </div>
        ...
        <input type="hidden" name="teslim_id" value="<?=$proje->teslim_id?>" >
        <input type="hidden" name="tmp_dosya" value="<?=$proje->teslim_dosya?>" >
